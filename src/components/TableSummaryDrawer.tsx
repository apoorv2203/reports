...
export function TableSummaryDrawer({ onClose, onEdit, onViewAccess }: Props) {
  ...
  return <aside className="fixed inset-y-0 right-0 z-40 flex w-full max-w-[520px] flex-col rounded-l-2xl border-l border-surface-200 bg-white shadow-drawer">
