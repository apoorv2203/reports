...
const variants: Record<NonNullable<AppButtonProps['variant']>, { variant: PrimitiveButtonVariant; size: PrimitiveButtonSize; className?: string }> = {
  primary: { variant: 'default', size: 'default', className: 'bg-mint-600 text-surface hover:bg-mint-700' },
  ...
  compact: { variant: 'default', size: 'sm', className: 'bg-mint-600 text-surface hover:bg-mint-700' },
};
