...
const styles: Record<AppCardVariant, string> = {
  default: '',
  widget: 'group relative flex min-h-[300px] flex-col rounded-lg border border-border bg-white p-3.5 shadow-card ring-0 transition hover:-translate-y-0.5 hover:border-border hover:shadow-floaty focus-within:ring-2 focus-within:ring-primary/20 focus-within:ring-offset-2',
  report: 'rounded-[14px] border border-border bg-white p-6 shadow-card-alt ring-0 transition hover:border-border focus-within:ring-2 focus-within:ring-primary/20 focus-within:ring-offset-2',
  recommendation: 'rounded-xl border border-border bg-white shadow-card-alt',
  admin: 'rounded-[14px] border border-border bg-white shadow-card-alt',
};
