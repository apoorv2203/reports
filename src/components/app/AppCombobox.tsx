...
export type AppComboboxOption = { value: string; label: string }
type AppComboboxProps = { options: AppComboboxOption[]; value?: string; onValueChange?: (value: string) => void; placeholder?: string; searchPlaceholder?: string; emptyText?: string; className?: string }

export function AppCombobox({ options, value, onValueChange, placeholder = "", searchPlaceholder = "", emptyText = "", className }: AppComboboxProps) {
