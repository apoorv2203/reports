...
export const apiConfig: Record<string, ApiDefinition> & { host: string; port: string; basePath: string } = {
  ...
  homeWidgets: api('homeWidgets'), widgetData: api('widgetData'), widgetMutations: api('widgetMutations'), pinnedReports: api('pinnedReports'), reports: api('reports'), reportDetails: api('reportDetails'), reportCreate: api('reportCreate'), reportUpdate: api('reportUpdate'), reportDelete: api('reportDelete'), reportPublish: api('reportPublish'), reportTemplates: api('reportTemplates'), reportTemplateRender: api('reportTemplateRender'), reportParameters: api('reportParameters'), reportParameterFields: api('reportParameterFields'), reportParameterize: api('reportParameterize'), reportRun: api('reportRun'), reportExport: api('reportExport'), widgetRecommendations: api('widgetRecommendations'),   widgets: api('widgets'), scheduledDeliveries: api('scheduledDeliveries'), scheduledDeliveryDownload: api('scheduledDeliveryDownload'),
};
