...
export const mockProviderRegistry: Record<string, MockProvider> = {
  ...
  reportRun: ({ params, body }) => reportMockProvider.runReport({ params, body }),
  reportParameterize: ({ params, body }) => reportMockProvider.parameterizeReport({ params, body }),
  reportPublish: ({ params, body }) => reportMockProvider.publishReport({ params, body }),
