...
export const addWidgetToHome = (widgetId: string) => request<import('@/api/types/widget').WidgetMutationResponse>('widgetMutations', { widgetId }, { body: { action: 'ADD' } });
export const removeWidgetFromHome = (widgetId: string) => request<import('@/api/types/widget').WidgetMutationResponse>('widgetMutations', { widgetId }, { body: { action: 'REMOVE' } });
